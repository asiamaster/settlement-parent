...
INSERT INTO `application_config` (`app_id`, `group_code`, `code`, `val`, `state`, `notes`) VALUES
	...
	(101, 102, 2, 'http://ia.diligrp.com:8381/earnestOrder/view.html', 1, 'group_code(102)表示业务详情URL'),
	(101, 103, 1, '', 1, 'group_code(103)表示缴费打印数据URL'),
	(101, 103, 2, 'http://ia.diligrp.com:8381/api/earnestOrder/queryPrintData', 1, 'group_code(103)表示缴费打印数据URL'),
	(101, 104, 1, '', 1, 'group_code(103)表示退款打印数据URL'),
	(101, 104, 2, 'http://ia.diligrp.com:8381/api/refundOrder/queryPrintData', 1, 'group_code(103)表示退款打印数据URL'),
