...
/** 市场ID 8 */
INSERT INTO `settle_config` (`market_id`, `group_code`, `code`, `val`, `state`, `notes`, `sort_field`) VALUES
	(8, 101, 1, '现金', 1, '初始数据(101支付方式)', 10),
	(8, 101, 2, 'POS', 1, '初始数据(101支付方式)', 20),
	(8, 101, 3, '银行卡转账', 1, '初始数据(101支付方式)', 30),
	(8, 101, 4, '支付宝', 1, '初始数据(101支付方式)', 40),
	(8, 101, 5, '微信', 1, '初始数据(101支付方式)', 50),
	(8, 101, 6, '组合支付', 1, '初始数据(101支付方式)', 60),
	(8, 101, 7, '虚拟支付', 2, '初始数据(101支付方式)', 70),
	(8, 101, 8, '园区卡', 1, '初始数据(101支付方式)', 80),
	(8, 102, 1, '现金', 1, '初始数据(102退款方式)', 10),
	(8, 102, 3, '银行卡转账', 1, '初始数据(102退款方式)', 20),
